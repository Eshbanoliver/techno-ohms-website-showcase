...
# Replace active nav
html = re.sub(
    r'<li><a href="#" class="active">HOME</a></li>\s*<li><a href="#">ABOUT US</a></li>',
    '<li><a href="index.html">HOME</a></li>\n                <li><a href="about.html" class="active">ABOUT US</a></li>',
    html
)

# Extract top and bottom
top_part = html.split('<!-- Hero Section -->')[0]
bottom_part = '    <!-- CTA Bar -->' + html.split('<!-- CTA Bar -->')[1]

# New Content
new_content = """<!-- Page Title Banner -->
    ...
    <section class="about-page-details">
        <div class="container">
            ...
            <p class="about-lead">We are a group specialized in the following activities:</p>
            <ul class="activities-list">
                <li><i class="fa-solid fa-check-double"></i> Supply, Installation and Commissioning of Danfoss Drives and Soft Starters</li>
                <li><i class="fa-solid fa-check-double"></i> Design, Manufacturing & Automation of various kind of L.T. Panels.</li>
                <li><i class="fa-solid fa-check-double"></i> Development of HMI / SCADA software.</li>
                <li><i class="fa-solid fa-check-double"></i> Flow/temperature/level transmitter and sensor.</li>
                <li><i class="fa-solid fa-check-double"></i> Upgrading old machinery panel.</li>
            </ul>

            <p class="about-lead mt-4">PSP techno engineers provides you customized & end-to-end solutions. We work as a primary vendor on site as we take full responsibility of design integration panel wiring, testing, and commissioning at site. The ultimate goal of our company is to provide value added services to our customer's value chain.</p>
            
            <p class="about-lead">PSP Techno aims to deliver comprehensive solutions ("Total Automation Solution"), and be one Stop Shop for all your process implementation needs. We help our clients achieve best in class process standards and thus making them to gain a competitive edge.</p>

            <p class="about-lead">Please check out our gallery to see all our hard work we have done in past...<br>
        ...
        <div class="container details-grid">
            <div class="desc-col">
                <div class="section-title text-left">
                    ...
                    <div class="ornament-left"><span></span></div>
                </div>
            ...
            <div class="img-col pt-4">
                <img src="images/Our-Product-Ranges.jpg" alt="Wiring Panel" class="full-img">
            </div>
            <div class="desc-col pt-4">
                <div class="section-title text-left">
                    <h2>Our Policies</h2>
                    <div class="ornament-left"><span></span></div>
                </div>
